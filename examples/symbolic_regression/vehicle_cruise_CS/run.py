...
Symbolic Regression for Vehicle Cruise Control Dataset
-----------------------------------------------
...
def main() -> None:
    ...
    learner = SymbolicRegression(
        ...
        step_width = 40,
        target_var = outputs,
        segmentation_args = {"niterations": 60,#30,
                             "random_state": 42, 
                             "parsimony":   0.00018142230721673977,#0.00010882946537224227,#0.00032, 
                             "binary_operators":["+", "-"], 
                             "unary_operators": ['sqrt', 'sin', 'cos'], 
                             "population_size": 56,#48,#42,
                             "model_selection": "best"},
        grouping_args = {"random_state": 42, 
                         "parsimony":   0.00018142230721673977,#0.00010882946537224227,  
                         "binary_operators": ["+", "-"], 
                         "unary_operators": ['sqrt', 'sin', 'cos'],
                         "population_size": 56,#30,
                         "model_selection": "best"},
    )
