...
def main() -> None:
    ...
    data = DataFrame.from_uri(uri="file:C:/Users/49157/Desktop/PA/2024---Harshitha-Viswanath---Project-Work/examples/symbolic_regression/smart_sensor/sampled_data.csv")
    
    inputs = ["time","input_u","output_y"]
    outputs = ["output_y"]
